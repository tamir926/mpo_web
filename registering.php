                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control mt-30" name="username" id="name" placeholder="Нэр">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control mt-30" name="username" id="name" placeholder="Нэвтрэх нэр">
                                                </div>

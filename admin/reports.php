    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Тайлан</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard">Нүүр хуудас</a>
                                    </li>
                                    <li class="breadcrumb-item active">Тайлан
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="reports?action=new"><i class="mr-1" data-feather="plus-square"></i><span class="align-middle">Тайлан нэмэх</span></a>
                                <!-- <a class="dropdown-item" href="reports?action=category_add"><i class="mr-1" data-feather="bar-chart-2"></i><span class="align-middle">Ангилал нэмэх</span></a> -->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                                ...
                                <div class="col-md-4 col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="reports?action=edit&id=<?=$podcast_id;?>" class="btn btn-outline-success">Засах</a>
                ...
                {
                    $podcast_id = $_GET["id"];
                    $sql = "SELECT *FROM reports WHERE id='$podcast_id'";
                    $result = mysqli_query($conn,$sql);
                    ...
                    <section id="input-group-basic">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="reports?action=adding" method="post" enctype="multipart/form-data">
                        ...
                        <a href="reports?action=delete&id=<?=$podcast_id;?>" class="btn btn-danger">Устгах</a>
                    </section>
                    <?
                }
                ?>
                ...
                if ($action=="editing")
                {
                    ...
                    if(isset($_FILES['image']) && $_FILES['image']['name']!="")
                    {
                        if ($_FILES['image']['name']!="")
                            {                        
                                ...
                                $sql = "UPDATE reports SET image ='$image' WHERE id='$podcast_id'";
                                mysqli_query($conn,$sql);
                            }
                    }

                    $sql = "UPDATE reports SET name='$name',youtube='$youtube',brief='$brief' WHERE id='$podcast_id'";
                    ...
                    ?>
                    <a class="btn btn-success" href="reports?action=edit&id=<?=$podcast_id;?>">Засах</a>
                    <a class="btn btn-primary" href="reports">Жагсаалт</a>
                    <?
                ...
                if ($action=="adding")
                {
                    ...
                    $sql = "INSERT INTO reports (name,youtube,brief,image)  VALUES ('$name','$youtube','$brief','$image')";
                ...
                if ($action=="delete")
                {
                    ...
                    if (mysqli_num_rows($result)==1)
                    {
                        ...
                        $sql = "DELETE FROM reports WHERE id='$podcast_id'";

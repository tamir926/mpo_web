    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Сэтгүүл</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard">Нүүр хуудас</a>
                                    </li>
                                    <li class="breadcrumb-item active">Сэтгүүл
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="magazine?action=new"><i class="mr-1" data-feather="plus-square"></i><span class="align-middle">Бүртгэх</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                                            ...
                                            <?
                                                ...
                                                while ($data = mysqli_fetch_array($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-success" href="magazine?action=edit&id=<?=$data["id"];?>">Засах</a></td>
                                                    </tr>
                                                    <?
                                                }
                                                ?>
                ...
                {
                    $magazine_id = $_GET["id"];
                    $sql = "SELECT *FROM magazine WHERE id='$magazine_id'";
                    $result = mysqli_query($conn,$sql);
                    if (mysqli_num_rows($result)==1)
                    {
                        $data = mysqli_fetch_array($result);
                        $magazine_title = $data["title"];
                        $magazine_number = $data["number"];
                        $magazine_date = $data["date"];
                        $magazine_image = $data["image"];
                        $magazine_pdf = $data["pdf"];

                    }
                    ?>
                    <section id="input-group-basic">
                        <form action="magazine?action=editing" method="post" enctype="multipart/form-data">
                            <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="title" value="<?=$magazine_title;?>" placeholder="Нэр..." required />
                                                </div>
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="number" value="<?=$magazine_number;?>" placeholder="Дугаар" required/>
                                                </div>
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="date" value="<?=$magazine_date;?>" placeholder="Огноо" required/>
                                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Сэтгүүлийн зураг болон файл</h4>
                                        </div>
                                        <div class="card-body">
                                        
                                            <img class="img-fluid d-block" src="../<?=$magazine_image;?>" />
                                            ...
                                            <a class="btn btn-success" src="../<?=$$magazine_pdf;?>" >Татах</a>
                    ...
                    <a href="magazine?action=delete&id=<?=$magazine_id;?>" class="btn btn-danger mt-3">Устгах</a>
                ...
                if ($action=="editing")
                {
                    ...
                    if(isset($_FILES['image']) && $_FILES['image']['name']!="")
                      {
                          if ($_FILES['image']['name']!="")
                              {                        
                                  ...
                                  $sql = "UPDATE magazine SET avatar='$target_file' WHERE id='$magazine_id'";
                    ...
                    if(isset($_FILES['pdf']) && $_FILES['pdf']['name']!="")
                      {
                          if ($_FILES['pdf']['name']!="")
                              {                        
                                  ...
                                  $target_file= substr($target_file,3);
                                  $sql = "UPDATE magazine SET pdf='$target_file' WHERE id='$magazine_id'";
                                  mysqli_query($conn,$sql);
          
                              }
                      }

                    $sql = "UPDATE magazine SET title='$title',number='$number',date='$date' WHERE id='$magazine_id'";
                    ...
                    ?>
                    <a class="btn btn-success" href="magazine?action=edit&id=<?=$magazine_id;?>">Засах</a>
                    <a class="btn btn-primary" href="magazine?action=detail&id=<?=$magazine_id;?>">Дэлгэрэнгүй</a>
                    <a class="btn btn-primary" href="magazine">Жагсаалт</a>
                    <?
                ...
                if ($action=="new")
                {
                    ?>
                    <section id="input-group-basic">
                        <form action="magazine?action=adding" method="post" enctype="multipart/form-data">
                            <div class="row">
                ...
                if ($action=="adding")
                {
                    ...
                    $sql = "INSERT INTO magazine (title,number,date,image,pdf) VALUES ('$title','$number','$date','$image','$pdf')";

                    if (mysqli_query($conn,$sql))
                    {
                        $magazine_id = mysqli_insert_id($conn);
                        ?>
                        <div class="alert alert-success" role="alert">
                            <div class="alert-body">
                                    ...
                                    <div class="card-body">
                                        <div class="user-info-wrapper">
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <p class="card-text mb-0"><?=$magazine_title;?></p>
                                            </div>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <p class="card-text mb-0"><?=$magazine_number;?></p>
                                            </div>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <p class="card-text mb-0"><?=$magazine_email;?></p>
                                            </div>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <p class="card-text mb-0"><?=$magazine_date;?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="../<?=$magazine_pdf;?>" class="btn btn-success mt-3">Татах</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                if ($action=="delete")
                {
                    ...
                    if (mysqli_num_rows($result)==1)
                    {
                        ...
                        if (mysqli_query($conn,$sql))
                        {
                            if (file_exists('../'.$magazine_image)) unlink('../'.$magazine_image);
                            if (file_exists('../'.$magazine_pdf)) unlink('../'.$magazine_pdf);
                            ?>
                            <div class="alert alert-success" role="alert">
                                <div class="alert-body">
                                   Амжилттай устгалаа

            ...
            <div class="content-body">
                                ...
                                <div class="card">
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            <?
                                                $count =0;
                                                $sql = "SELECT *FROM organisation ORDER BY created_at DESC";
                                                ...
                                                while ($data = mysqli_fetch_array($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a class="btn btn-primary" href="organisation?action=detail&id=<?=$data["id"];?>">Дэлгэрэнгүй</a>
                                                                <a class="btn btn-success" href="organisation?action=edit&id=<?=$data["id"];?>">Засах</a></td>
                                                            </div>
                ...
                if ($action=="edit")
                {
                    ...
                    <section id="input-group-basic">
                        ...
                        <a href="organisation?action=delete&id=<?=$organisation_id;?>" class="btn btn-danger">Устгах</a>
                ...
                if ($action=="editing")
                {
                          ...
                          if ($_FILES['image']['name']!="")
                              {                        
                                ...
                                //   imagejpeg($thumb_image_content,$thumb,75);
                                  ...
                                  $sql = "UPDATE organisation SET logo='$target_file' WHERE id='$organisation_id'";
                    ...
                    $sql = "UPDATE organisation SET name='$name',presenter_name='$presenter_name',presenter_position='$presenter_position',email='$email',tel='$tel' WHERE id='$organisation_id'";
                ...
                if ($action=="adding")
                {
                    ...
                    $sql = "INSERT INTO organisation (name,url,logo) VALUES ('$name','$url','$target_file')";
                ...
                if ($action=="delete")
                {
                    ...
                    if (mysqli_num_rows($result)==1)
                    {
                        ...
                        $sql = "DELETE FROM organisation WHERE id='$organisation_id'";

            ...
            <div class="content-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?
                                            $sql = "SELECT *FROM feedback_mbtbb ORDER BY timestamp DESC";
                                            ...
                                            ?>
                                                    <tr class="hover:bg-gray-400">
                                                        <td><?= $count++; ?></td>
                                                        <td><a href="feedback_mbtbb?action=detail&id=<?= $data["id"]; ?>"><?= $data["name"]; ?></a></td>
                                                        <td><a href="feedback_mbtbb?action=detail&id=<?= $data["id"]; ?>"><?= $data["contact"]; ?></a></td>
                                                        <td>
                                                            <a href="feedback_mbtbb?action=detail&id=<?= $data["id"]; ?>" title="Харах" class="btn btn-primary">
                                                                Харах
                                                            </a>
                                                        </td>
                                                    </tr>
                ...
                if ($action == "detail") 
                {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body d-flex flex-column justify-content-between border-container-lg">

                                    <?
                                    if (isset($_GET["id"])) $feedback_id = $_GET["id"];
                                    else header("location:feedback_mbtbb");
                                    $sql = "SELECT *FROM feedback_mbtbb WHERE id=$feedback_id LIMIT 1";
                                    $result = mysqli_query($conn, $sql);
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>Нэр</td><td><?=$data["name"];?></td>
                                            </tr>
                                            <tr>
                                                <td>Утас</td><td><?=$data["contact"];?></td>
                                            </tr>
                                            <tr>
                                                <td>Имэйл</td><td><?=$data["email"];?></td>
                                            </tr>
                                            <tr>
                                                <td>Гарчиг</td><td><?=$data["title"];?></td>
                                            </tr>
                                            <tr>
                                                <td>Агуулга</td><td><?=$data["content"];?></td>
                                            </tr>
                                        </tbody>
                                    </table>

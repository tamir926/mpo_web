    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="form-group breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="volunteers_persons?action=new"><i class="mr-1" data-feather="plus-square"></i><span class="align-middle">Бүртгэх</span></a>
                            </div>
                        </div>
                    </div>
                </div> -->
            ...
            <div class="content-body">
                                ...
                                <div class="card">
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            <?
                                                $count =0;
                                                $sql = "SELECT *FROM volunteers_person ORDER BY created_at DESC";
                                                ...
                                                while ($data = mysqli_fetch_array($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a class="btn btn-primary" href="volunteers_persons?action=detail&id=<?=$data["id"];?>">Дэлгэрэнгүй</a>
                                                                <a class="btn btn-success" href="volunteers_persons?action=edit&id=<?=$data["id"];?>">Засах</a></td>
                                                            </div>
                ...
                {
                    $person_id = $_GET["id"];
                    $sql = "SELECT *FROM volunteers_person WHERE id='$person_id'";
                    $result = mysqli_query($conn,$sql);
                    ...
                    <section id="input-group-basic">
                        <form action="volunteers_persons?action=editing" method="post" enctype="multipart/form-data">
                            <div class="row">
                        ...
                        <a href="volunteers_persons?action=delete&id=<?=$person_id;?>" class="btn btn-danger">Устгах</a>
                ...
                if ($action=="editing")
                {
                          ...
                          if ($_FILES['image']['name']!="")
                              {                        
                                ...
                                //   imagejpeg($thumb_image_content,$thumb,75);
                                  ...
                                  $sql = "UPDATE volunteers_person SET photo='$target_file' WHERE id='$person_id'";
                    ...
                    $sql = "UPDATE volunteers_person SET name='$name',email='$email',tel='$tel' WHERE id='$person_id'";
                    ...
                    ?>
                    <a class="btn btn-success" href="volunteers_persons?action=edit&id=<?=$person_id;?>">Засах</a>
                    <a class="btn btn-primary" href="volunteers_persons?action=detail&id=<?=$person_id;?>">Дэлгэрэнгүй</a>
                    <a class="btn btn-primary" href="volunteers_person">Жагсаалт</a>
                    <?
                ...
                if ($action=="new")
                {
                    ?>
                    <section id="input-group-basic">
                        <form action="volunteers_persons?action=adding" method="post" enctype="multipart/form-data">
                            <div class="row">
                ...
                if ($action=="adding")
                {
                    ...
                    $sql = "INSERT INTO volunteers_person (name,url,logo) VALUES ('$name','$url','$target_file')";
                ...
                if ($action=="delete")
                {
                    ...
                    if (mysqli_num_rows($result)==1)
                    {
                        ...
                        $sql = "DELETE FROM volunteers_person WHERE id='$person_id'";
                    ...
                    header("location:volunteers_person");

        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="nav-item"><a class="nav-link d-flex align-items-center" href="dashboard"><i data-feather="home"></i> Нүүр хуудас</a>
                    </li>
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item d-flex align-items-center dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Cards"><i data-feather="credit-card"></i><span data-i18n="Мэдээ">Мэдээ</span></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li data-menu="">
                                        <a class="dropdown-item d-flex align-items-center" href="news?action=category" data-toggle="dropdown" data-i18n="Basic"><i data-feather="circle"></i><span data-i18n="Basic">Ангилал</span></a>
                                    </li>
                                </ul>

                            </li>

                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item d-flex align-items-center dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Cards"><i data-feather="credit-card"></i><span data-i18n="Арга хэмжээ">Арга хэмжээ</span></a>
                                <ul class="dropdown-menu">
                                    <li class="active" data-menu="">
                                        <a class="dropdown-item d-flex align-items-center" href="events?action=new" data-toggle="dropdown" data-i18n="Basic"><i data-feather="circle"></i><span data-i18n="Basic">Шинэ арга хэмжээ</span></a>
                                    </li>
                                    <li data-menu="">
                                        <a class="dropdown-item d-flex align-items-center" href="events?action=grid" data-toggle="dropdown" data-i18n="Advance"><i data-feather="circle"></i><span data-i18n="Advance">Бүх арга хэмжээ</span></a>
                                    </li>
                                    <li data-menu="">
                                        <a class="dropdown-item d-flex align-items-center" href="events?action=category" data-toggle="dropdown" data-i18n="Basic"><i data-feather="circle"></i><span data-i18n="Basic">Ангилал</span></a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="pages" data-toggle="dropdown" ><i data-feather="circle"></i><span >Хуудсууд</span></a></li>
                    ...
                    <!-- <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="slider" data-toggle="dropdown" ><i data-feather="image"></i><span >Солигддог зураг</span></a></li> -->

                    ...
                    <div class="container gray-bg pt-100 pb-100 text-center jambotron">
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                ...
                                <p>Та өөрийн сертификатын дугаар, регистрын дугаар оруулснаар сертификатын мэдээллийг авах ба төлбөртэйгээр ахин авах боломжтой.</p>
                                <form action="certificate_redeem" method="post">
                                    ...
                                    <button class="btn btn-success btn-xl mt-10" onclick="submit();">Хайх</button>
                                </form>

                ...
                if(isset($_FILES['excel']))
                    {                       
                        ...
                        if ($fullname<>"")
                        {
                            ...
                            echo "Амжилттай илгээлээ";
                            else 
                            echo "Илгээхэд алдаа гарлаа.".mysqli_error($conn);
                        }
                        else 
                        {
                            echo "Excel файлын овог нэр талбар хоосон байна.";
                        }
                        if (file_exists($target_file)) unlink($target_file);
                    }
                    else echo "Excel файл олдсонгүй";
                ?>
            </div>
            <?
        }
                                ...
                                <form action="application_bm" method="POST" class="contact-form" enctype="multipart/form-data" onSubmit="submitForm();" >
                                    ...
                                    <div class="select-amount">
                                        ...
                                        <div class="login-form">
                                            <h3>ББ-10 Өргөдлийн маягт БМ</h3>
                                            <p>Та өргөдлийн маягтыг excel файлыг татан авж бөглөн илгээнэ үү. <a href="files/mpo_mbbtb_application_bm.xlsx" target="new">Excel файлыг эндээс татна уу.</a></p>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group mt-30">
                                                        Бөглөсөн excel файлаа сонгоно уу
                                                    ...
                                                    <div class="form-group mt-30">
                                                        Нэмэлт хавсаргах файл байвал оруулна уу.
                                                    ...
                                                    <div class="form-group mt-30">   
                                                        ...
                                                        Би,  <a href="#" class="mpo_a"><b>Үйлчилгээний нөхцөлийг</b> </a> хүлээн зөвшөөрч байна.
                                                        </p>                                                 
                                                    </div>
                                                    ...
                                                    <div class="form-group mt-30">   
                                                        <p>
                                                        <input type="checkbox" name="confidential" required> 
                                                        Би,  <a href="#" class="mpo_a"><b>Нууцлалын нөхцөлийг</b> </a> хүлээн зөвшөөрч байна.
                                                        </p>                                                 
                                                    </div>

                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 mx-auto text-justify col-sm-12">
                            <div class="donate-form">
                                <form action="application_bam" method="POST" class="contact-form" enctype="multipart/form-data" onSubmit="submitForm();" >
                                    <input type="hidden" name="timestamp" value="<?=date("Y-m-d H:i:s");?>
                                    <div class="select-amount">
                                        <!-- .select-amount -->
                                        <div class="login-form">
                                            <h3>F-CB-11 Application form SPS</h3>
                                            <p>Please download the application form as an excel file, fill it and submit it. <a href="../files/Application_11_eng.xlsx" target="new">Download the Excel file here.</a></p>
                                            <div class="row">
                                                <div class="col-lg-12">

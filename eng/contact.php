    ...
    <div class="box-layout">
        ...
        <div class="submenu">
            <div class="container d-flex justify-content-between">
                <h3 class="text-black">to contact</h3>
                <ul class="submenu-ul">
            ...
            <div class="container">
                <div class="row">
                    <div class="contact-us">
                        <div class="row">
                            <div class="col-lg-8">
                                <h3 class="contact-title">Send feedback</h3>
                                <form action="contacting" method="POST" class="contact-form">
                                    <div class="row">
                                        <div class="col-md-12 mb-1">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="nameId" name="name" placeholder="Your name">
                                            </div>
                                            <!-- .form-group -->
                                        </div>
                                        <!-- .col-md-6 -->
                                    ...
                                    <button type="submit " class="btn btn-default mb-1">Send</button>
                                </form>
                            </div>
                            <div class="col-lg-4">

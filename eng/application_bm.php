                                ...
                                <form action="application_bm" method="POST" class="contact-form" enctype="multipart/form-data" onSubmit="submitForm();" >
                                    ...
                                    <div class="select-amount">
                                        ...
                                        <div class="login-form">
                                            <h3>ББ-10 Application form БМ</h3>
                                            <p>Please download the application form as an excel file, fill it and submit it. <a href="files/mpo_mbbtb_application_bm.xlsx" target="new">Download the Excel file here.</a></p>
                                            <div class="row">
                                                <div class="col-lg-12">

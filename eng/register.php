                                    ...
                                    <div class="contact-form">
                                        ...
                                        if (isset($_POST["name"]) && isset($_POST["tel"]) && isset($_POST["email"]) && isset($_POST["username"]) && isset($_POST["password"]))
                                        {
                                            ...
                                            if (mysqli_num_rows($result)==0)
                                            {
                                                if ($password==$password2)
                                                {
                                                    ...
                                                    if (mysqli_query($conn,$sql))
                                                    {
                                                        ...
                                                        <a href="login" class="btn btn-secondary w-100 mt-30">Login</a>
                                                        <?
                                                    }
                                                    else 
                                                    {
                                                        ...
                                                        <a href="register" class="btn btn-warning w-100 mt-30">Register</a>
                                                        <?
                                                    }
                                            ...
                                            else 
                                            {
                                                ?>
                                                <div class="alert ">
                                                Have a login name, phone number or email account. 
                                                </div>        
                                        ...
                                        else 
                                        {
                                            ...
                                            <form action="register" method="POST" class="contact-form">
                                                <p>If you are registered with us <a href="login" class="login">Click here</a> please log in.</p>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="radio" name="type" value="1"> Organization
                                                            <input type="radio" name="type" value="0"> An individual
                                                        </div>

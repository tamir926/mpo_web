    ...
    <div class="box-layout">       
        ...
        <section class="col-lg-6 mx-auto">
                <div class="container bg pt-50 pb-50">
                            <h2 class="text-center">PRODUCTIVITY SPECIALIST</h2>
                            <p>•	University degree or diploma with at least 5 years of work experience or equivalent.</p>
                            <p>•	Attended any of these training programmes:
                            <ul class="mpo-ul">
                                ...
                                <li>Aggregation of short training covering at least 8 Productivity Solution</li>
                            </ul>
                            </p>
                            <p>•	2 years of work experience with implementation of a minimum of 2 projects in productivity improvement;</p>
                            <p>•	Minimum of 200 *work hours on consultancy, training, promotion, and/or research in the last 12 months</p>
                            <p>•	Submit at least 2 positive testimonials from clients on productivity projects undertaken in the last 24 months.</p>

                        ...
                        <div class="row">        
                            ...
                            <div class="col-lg-12 col-sm-6 col-12">
                                <div class="d-flex justify-content-between mpo-list">
                                    <a href="application_bm">АШБ:ББ-10 Application form БМ</a>
                            ...
                            <div class="col-lg-12 col-sm-6 col-12">
                                <div class="d-flex justify-content-between mpo-list">
                                    <a href="application_bam">АШБ:ББ-11 Application form БАМ</a>
                            ...
                            <div class="col-lg-12 col-sm-6 col-12">
                                <div class="d-flex justify-content-between mpo-list">
                                    <a href="application_bmm">АШБ:ББ-12 Application form БММ</a>
                            ...
                            <div class="col-lg-12 col-sm-6 col-12">
                                <div class="d-flex justify-content-between mpo-list">
                                    <a href="application_re">АШБ:ББ-13 Application form /Repeated verification/</a>

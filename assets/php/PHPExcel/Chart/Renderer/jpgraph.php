...
class PHPExcel_Chart_Renderer_jpgraph
{
	...
	private function _renderAreaChart($groupCount, $dimensions = '2d') {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_line.php');
	...
	private function _renderBarChart($groupCount, $dimensions = '2d') {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_bar.php');
	...
	private function _renderScatterChart($groupCount) {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_scatter.php');
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_regstat.php');
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_line.php');
	...
	private function _renderPieChart($groupCount, $dimensions = '2d', $doughnut = False, $multiplePlots = False) {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_pie.php');
		if ($dimensions == '3d') {
			require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_pie3d.php');
		}
	...
	private function _renderRadarChart($groupCount) {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_radar.php');
	...
	private function _renderStockChart($groupCount) {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_stock.php');
	...
	private function _renderContourChart($groupCount,$dimensions) {
		require_once('Classes/PHPExcel/Chart/Renderer/jpgraph_contour.php');

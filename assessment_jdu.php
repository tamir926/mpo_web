            ...
            <div class="container">
                <div class="row">
                            <div class="col-lg-12">
                                ...
                                if (!empty($_POST))
                                {
                                    $jdu1 = intval($_POST["jdu1"]);
                                    $jdu2 = intval($_POST["jdu2"]);
                                    $jdu3 = intval($_POST["jdu3"]);
                                    $jdu4 = intval($_POST["jdu4"]);
                                    $jdu5 = intval($_POST["jdu5"]);
                                    $jdu6 = intval($_POST["jdu6"]);
                                    $jdu7 = intval($_POST["jdu7"]);
                                    $jdu8 = intval($_POST["jdu8"]);
                                    $jdu9 = intval($_POST["jdu9"]);
                                    $jdu10 =intval($_POST["jdu10"]);
                                    $jdu11 = intval($_POST["jdu11"]);
                                    $jdu12 = intval($_POST["jdu12"]);
                                    $jdu13 = intval($_POST["jdu13"]);
                                    $jdu14 = intval($_POST["jdu14"]);
                                    $jdu15 = intval($_POST["jdu15"]);
                                    $jdu16 = intval($_POST["jdu16"]);
                                    $jdu17 = intval($_POST["jdu17"]);
                                    $jdu18 = intval($_POST["jdu18"]);
                                    $jdu19 = intval($_POST["jdu19"]);
                                    $jdu20 =intval($_POST["jdu20"]);
                                    $jdu21 = intval($_POST["jdu21"]);
                                    $jdu22 = intval($_POST["jdu22"]);
                                    $jdu23 = intval($_POST["jdu23"]);
                                    $jdu24 = intval($_POST["jdu24"]);

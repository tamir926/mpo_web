                                ...
                                <div class="container gray-bg pt-50 pb-50 jambotron">
                                    ...
                                    <div class="team-address-box">
                                            ...
                                            <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                                                <span>Хүмүүнлэгийн ухааны их Сургуулийн Дээд-Доктор 2012/2019</span>
                                                </li>
                                            <li>
                                                <i class="fa fa-home" aria-hidden="true"></i>
                                                <span>Монгол-Дорноговь аймаг, Сайншанд</span>
                                            </li>
                                            <li>
                                                <i class="fa fa-id-card-o" aria-hidden="true"></i>
                                                <span>Төрсөн он: 1984</span>
                                            </li>
                                            <li>
                                            <i class="fa fa-handshake-o" aria-hidden="true"></i>
                                                <span>Салбарын туршлага: Мэргэжлийн үйлчилгээ, Хүнс хөдөө аж ахуй, Дижитал бүтээмж, Хувийн эрүүл мэндийн үйлчилгээ, Аялал жуучлал</span>
                                            </li>
                                            <li>
            ...
            <div class="container text-center pt-50 pb-50">
                <div class="row">
                    ...
                    <i class="fa fa-level-up" aria-hidden="true"><h4 class="text-black text-left">Бүтээмж дээшлүүлэх анхан шатны арга хэрэгсэл</h4></i>
                            <p>Инноваци, Чанарын дугуйлан, Ажилчдын саналын</p>
                    ...
                    <i class="fa fa-level-up" aria-hidden="true"><h4 class="text-black">Бүтээмж дээшлүүлэх ахисан шатны хэрэгсэл</h4></i>
                        <p>ISO 9000, Бизнесийн төгөлдөршил, Төрийн байгууллагын</p>
                        <p>бүтээмж, 6 сигмаБизнесийн процессын дахин инженерчлэл,</p>
                        <p>Өөрчлөлтийн менежмент,Хэрэглэгчийн  сэтгэл ханамж,</p>
                        <p>Чанарын нэгдсэн удирдлага, Ажлын байрны сургалт</p>
                    </div>
                </div>
            </div>
        </section>

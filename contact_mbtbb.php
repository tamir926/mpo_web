                    ...
                    <div class="contact-us">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form action="contacting_mbtbb" method="POST" class="contact-form">
                                    <div class="row">
                                        <div class="col-md-12 mb-1">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="nameId" name="name" placeholder="Таны нэр">
                                            </div>
                                            <!-- .form-group -->
                                        </div>
                                        <!-- .col-md-6 -->
                                        <div class="col-md-12 mb-1">
                                            <div class="form-group">
                                                <input type="email" class="form-control" id="emailId" name="email" placeholder="Имэйл">
                                            </div>
                                        </div>
                                    ...
                                    <textarea class="form-control text-area mb-1" rows="3" placeholder="Message" name="message"></textarea>
                                    <button type="submit " class="btn btn-default mb-1">Илгээх</button>
                                </form>
                            </div>
                            <div class="col-lg-4">
